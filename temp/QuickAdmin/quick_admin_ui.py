...
class Ui_QuickAdmin(object):
    def setupUi(self, QuickAdmin):
        ...
        self.cmbLabel.setEditable(False)
        ...
        self.txtNewLabel = QtWidgets.QLineEdit(QuickAdmin)
        self.txtNewLabel.setGeometry(QtCore.QRect(340, 500, 201, 20))
        self.txtNewLabel.setObjectName("txtNewLabel")
        self.cmdSaveLabel = QtWidgets.QPushButton(QuickAdmin)
        self.cmdSaveLabel.setGeometry(QtCore.QRect(550, 500, 75, 23))
    ...
    def retranslateUi(self, QuickAdmin):
        ...
        self.cmdSaveLabel.setText(_translate("QuickAdmin", "Save"))
